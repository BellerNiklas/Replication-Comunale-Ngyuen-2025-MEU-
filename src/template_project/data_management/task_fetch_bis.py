"""Pytask tasks for fetching BIS data."""
...
from template_project.data_fetch.bis import fetch_one, generate_all_variable_configs
...
for category_num, category_name in CATEGORIES.items():
    ...
    def task_fetch_bis_category(
        ...
        """Fetch all BIS variables for one category."""
