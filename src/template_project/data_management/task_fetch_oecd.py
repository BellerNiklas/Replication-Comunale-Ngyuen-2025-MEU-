"""Pytask tasks for fetching OECD data."""
...
from template_project.data_fetch.oecd import fetch_one, generate_all_variable_configs
...
for category_num, category_name in CATEGORIES.items():
    ...
    def task_fetch_oecd_category(
        ...
        """Fetch all OECD variables for one category."""
