"""Pytask tasks for fetching Eurostat data."""
...
from template_project.data_fetch.eurostat import fetch_one, generate_all_variable_configs
...
for category_num, category_name in CATEGORIES.items():
    ...
    def task_fetch_eurostat_category(
        ...
        """Fetch all Eurostat variables for one category."""
